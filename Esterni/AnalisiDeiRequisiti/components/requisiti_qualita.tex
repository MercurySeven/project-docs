\subsection{Requisiti di qualità}
{
    ...
    \begin{longtable}{C{.20\freewidth} C{.40\freewidth} C{.20\freewidth} C{.20\freewidth}}
        ...
        RQO04    & Il codice sorgente dell'applicazione deve essere disponibile in una \glo{repository} pubblica su \glo{GitHub} & Obbligatorio & Decisione interna \\
        RQD05    & Il codice sorgente deve essere testato con opportuni \glo{test} e avere una copertura almeno del 80\% & Desiderabile & Decisione interna \\
        RQD06    & All'interno del \glo{repository} di \glo{GitHub} deve essere presente un \glo{sistema} di Continuous Integration & Desiderabile & Decisione interna \\
