\subsection{Requisiti di vincolo}
{
    ...
    \begin{longtable}{C{.20\freewidth} C{.40\freewidth} C{.20\freewidth} C{.20\freewidth}}
        ...
        RVO05    & L'applicazione deve poter comunicare con \glo{Zextras Drive} & Obbligatorio & Capitolato \\
        ...
        RVO07    & Utilizzo del pattern \glo{MVC} per la separazione della \glo{Business logic} e la UI & Obbligatorio & Capitolato \\
