...
Il capitolato chiede di sviluppare un algoritmo e un'applicazione per la sincronizzazione file tra server e client appoggiandosi sul sevizio Zextras Drive.
...
\item \textbf{Materiale didattico del corso di Ingegneria del Software:}
    ...
    \end{itemize}
\item \textbf{Documentazione Zextras Drive API}
