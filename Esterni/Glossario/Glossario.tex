...
\begin{description}
  ...
  \item[Business logic] Si riferisce a tutta quella logica o nucleo (core) di elaborazione (sotto forma di codice sorgente) che rende operativa un'applicazione, quindi l'algoritmica che gestisce lo scambio di informazioni tra l'\glo{interfaccia utente} con le elaborazioni intermedie sui dati.
\end{description}
\newpage
\section{C}
\begin{description}
...
\section{W}
\begin{description}
  \item[Workspace] É uno spazio di lavoro digitale, messo a disposizione da \glo{Slack}. É costituito da canali testuali, che offrono svariate funzionalità, in cui i membri del \glo{team} possono comunicare e lavorare insieme.
\end{description}
\newpage
\section{Z}
\begin{description}
  \item[Zextras Drive] É un nuovo componente \glo{Zimbra} che fornisce sia un sistema di archiviazione di file completo, integrato con Zimbra WebClient.
