...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c C{6cm} C{3cm} C{3cm} }
				...
				\textbf{Metrica} & \textbf{Obiettico} & \textbf{Valori accettati} & \textbf{Valori ottimali}  \\
				\toprule
				MPRC001 & Monitoraggio del rispetto della timeline da parte del gruppo & $ x \leq -5$ giorni & $0$ giorni \\
				MPRC002 & Monitoraggio dell'utilizzo eccessivo di risorse fuori budget & $ x \leq 10 \%$ & $0 \%$ \\
				\bottomrule
			\end{tabular}
			\caption{Tabella delle metriche e degli obiettivi}
		\end{center}
	\end{table}
