...
\begin{itemize}
    \item \textbf{Individuazione dei rischi}: \textit{attività di identificazione dei possibili fattori che potrebbero compromettere il corretto proseguimento del progetto;}
    \item \textbf{Analisi dei rischi}: \textit{attività di analisi di tali fattori con lo scopo di individuarne la gravità e la probabilità che essi si verifichino;}
    \item \textbf{Pianificazione di controllo}: \textit{attività di pianificazione delle streategie da adottare per evitare che si verifichino i rischi individuati o per gestirli al meglio qualora si verifichino;}
    \item \textbf{Monitoraggio dei rischi}: \textit{attività continua eseguita con l'obiettivo di monitorare l'insorgenza di problematiche legate ai fattori di rischio e permettere l'applicazione tempestiva delle strategie di contenimento individuate.}
\end{itemize}
	...
	\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c c }
                ...
                \toprule
                Descrizione & Il \glo{team} presanta un'esperienza eterogenea e superficiale nell'utilizzo di molte tecnologie richieste in questo progetto. \\
    ...
    \begin{table}[H]
        \begin{center}
            ...
            \begin{tabular}{ c c }
                ...
                %\textbf{Prima colonna} & \textbf{Seconda colonna}  \\
                \toprule
                Descrizione & il \glo{team} si avvale di servizi e software di terze parti per la gestione dei documenti e della \glo{codebase}. La buona gestione di questi ultimi non è competenza del \glo{team}. \\
...
\paragraph{Riradi Nella Consegna}
\renewcommand{\arraystretch}{1}
    \begin{table}[H]
        \begin{center}
            \setlength{\aboverulesep}{0pt}
