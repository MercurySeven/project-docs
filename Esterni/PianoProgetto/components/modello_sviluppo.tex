...
\begin{enumerate}
    ...
    \item \textbf{La collaborazione col cliente più che la negoziazione dei contratti}: un contratto inflessibile può essere una potenziale perdità di valore per per tutte le parti coinvolte. Va quindi incentivata l’interazione con gli \glo{stakeholder} durante lo sviluppo del progetto;
...
% FIXME compila con rientro sfasato
I \textbf{vantaggi} principali di questo modello sono quindi, come riportato sopra, la facilità di adattamento in base alle esigenze da parte del \glo{team}, 
