...
\begin{figure}[H]
    ...
    \label{fig:\glo{Diagramma di Gantt}, fase di Analisi}
\end{figure}
...
Le post condizioni sono:
\begin{itemize}
	\item conclusione della preparazione della presentazione da esporre per la Revisione dei \glo{Requisiti};
...
\begin{itemize}
	...
	\item preparazione alla presentazione per la Revisione dei \glo{Requisiti};
