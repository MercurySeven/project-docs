...
Questo periodo ha inizio il 2021-03-11 e si conclude il 2021-04-09, include lo \glo{sprint} 8 e lo \glo{sprint} 9.
Le precondizioni sono:
\begin{itemize}
...
Questo \glo{sprint} ha inizio in data 2021-03-11 e si conclude in data 2021-03-25.  Le sue precondizioni sono il raggiungimento degli obiettivi dello \glo{sprint} precedente.\newline{}
Gli obiettivi da raggiungere durante questo periodo sono:
\begin{itemize}
	\item Correzione e \glo{verifica} delle \NdP{};
	\item Aggiornamento, correzione e \glo{verifica} del \PdP{};
	\item Redazione introduzione, informazioni su tecnologie, librerie e setup dell'IDE nel documento del \MS{};
	\item Aggiornamento, correzione e \glo{verifica} del \PdQ{};
	...
	\item Stesura \glo{test};
	\item Implementazione pattern scelti;
	\item Implementazione gestione errori di rete;
	\item \glo{Verifica} del codice;
	\item Aggiornamento del \G{}.
\end{itemize}

\subsubsection{Sprint 9}
Questo \glo{sprint} ha inizio in data 2021-03-26 e si conclude in data 2021-04-09. Le sue precondizioni sono il raggiungimento degli obiettivi dello \glo{sprint} precedente.\newline{}
Gli obiettivi da raggiungere durante questo periodo sono:
\begin{itemize}
	\item Redazione \glo{test} ed architettura nel documento \MS{};
	\item \glo{Verifica} del \MS{};
	\item Aggiornamento, correzione e \glo{verifica} del \PdP{};
	\item Realizzazione e \glo{verifica} del \MU{};
	\item Stesura \glo{test};
	\item Rifattorizzazione algoritmo di sincronizzazione;
	\item Miglioramento GUI;
	\item Pulizia del codice;
	\item Aggiornamento e \glo{verifica} del \G{}.
\end{itemize}
...
Questo periodo ha inizio il 2021-04-10 e si conclude il 2021-05-21, include lo \glo{sprint} 10, 11 e 12.
Le precondizioni sono:
\begin{itemize}
...
\begin{itemize}
	...
	\item \textbf{Sviluppo \ignore{software}:} questa attività consiste nella scrittura dei \glo{test}, nella scrittura del codice e della sua \glo{verifica};
	\item \textbf{\glo{Validazione} e collaudo:} vengono eseguiti ulteriori \glo{test} sul prodotto, in modo da garantire la correttezza e un buon livello di qualità.
\end{itemize}
...
Questo \glo{sprint} ha inizio in data 2021-04-10 e si conclude in data 2021-04-23. Le sue precondizioni sono il raggiungimento degli obiettivi dello \glo{sprint} precedente.\newline{}
Gli obiettivi da raggiungere durante questo periodo sono:
\begin{itemize}
	\item Aggiornamento, correzione e \glo{verifica} del \PdP{};
	\item Aggiornamento, correzione e \glo{verifica} del \PdQ{};
	...
	\item Miglioramento e maggior utilizzo del \ignore{sistema} di notifiche;
	\item Implementazione scelta intervallo di sincronizzazione;
	\item \glo{Verifica} codice;
	\item Aggiornamento del glossario;
	\item \glo{Verifica} del glossario.
\end{itemize}
\subsubsection{Sprint 11}
Questo \glo{sprint} ha inizio in data 2021-04-24 e si conclude in data 2021-05-07. Le sue precondizioni sono il raggiungimento degli obiettivi dello \glo{sprint} precedente.\newline{}
Gli obiettivi da raggiungere durante questo periodo sono:
\begin{itemize}
	\item Aggiornamento, correzione e \glo{verifica} del \PdP{};
	\item Aggiornamento, correzione e \glo{verifica} del \MS{};
	\item Aggiornamento, correzione e \glo{verifica} del \MU{};
	\item Stesura \glo{test};
	\item Implementazione whitelist per la selezione dei file da sincronizzare;
	\item Implementazione \ignore{sistema} di logout;
	...
	\item \glo{Verifica} codice;
	\item Aggiornamento del \G{};
	\item \glo{Verifica} del \G{}.
\end{itemize}
\subsubsection{Sprint 12}
Questo \glo{sprint} ha inizio in data 2021-05-08 e si conclude in data 2021-05-21. Le sue precondizioni sono il raggiungimento degli obiettivi dello \glo{sprint} precedente.\newline{}
Gli obiettivi da raggiungere durante questo periodo sono:
\begin{itemize}
	\item Implementazione icona di file sincronizzato;
	\item Implementazione icona di file in sincronizzazione;
	\item Superamento ed implementazione di tutti i \glo{test di \ignore{unità}} automatici;
	\item Superamento dei \glo{test di \ignore{sistema}};
	\item Rilascio eseguibile multipiattaforma;
	\item \ignore{Verifica} ed approvazione finale di tutti i documenti.
\end{itemize}
\subsubsection{Timeline: sprint 10, 11 e 12}
\begin{figure}[H]
    \centering
