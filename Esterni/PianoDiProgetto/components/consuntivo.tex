...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ l c c c c c c c }
				...
				Miglioramento \ignore{sistema} di notifiche. & \checkmark{} \\
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ l c c c c c c c }
				...
				Implementazione del \ignore{sistema} di logout. & \checkmark{} \\
...
\begin{itemize}
	\item \textbf{Stato obiettivi:} Non tutti gli obiettivi preventivati sono stati realizzati. L'obiettivo mancante (messaggio di errore nell'autenticazione) verrà realizzato nel prossimo \glo{sprint};
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ l c c c c c c c }
				...
				Implementazione e superamento di tutti i \glo{test di \ignore{unità}} & \checkmark{} \\
				Superamento dei \glo{test di \ignore{sistema}}. & \checkmark{} \\ 
				Rilascio eseguibile multipiattaforma. & \checkmark{} \\
				\ignore{Verifica} ed approvazione finale di tutti i documenti. & \checkmark{} \\
				\bottomrule
			\end{tabular}
...
\subsubsection{Consuntivo di periodo}
Le seguenti tabelle contengono i dati del consuntivo per il periodo di progettazione di \glo{validazione} e collaudo, riassumendo le tabelle di consuntivo dello \glo{sprint} 10, 11 e 12. La prima tabella contiene il consuntivo degli obiettivi, con \checkmark{} indicante gli obiettivi completati e \xmark{} per indicare gli obiettivi non completati. La seconda tabella invece contiene i dati economici del consuntivo.\newline{}
Le seguenti tabelle contengono i dati del consuntivo per il periodo di progettazione di \glo{validazione} e collaudo, riassumendo le tabelle di consuntivo dello \glo{sprint} 10, 11 e 12:
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ l c c c c c c c }
				...
				Implementazione icona di file sincronizzato. & \checkmark{} \\
				Implementazione icona di file in sincronizzazione. & \checkmark{} \\
				Implementazione e superamento di tutti i \glo{test} di \glo{unità} & \checkmark{} \\
				Superamento dei \glo{test di \ignore{sistema}}. & \checkmark{} \\ 
				Rilascio eseguibile multipiattaforma. & \checkmark{} \\
				\ignore{Verifica} ed approvazione finale di tutti i documenti. & \checkmark{} \\
				\bottomrule
...
\subsubsection{Considerazioni e preventivo a finire}
Il ruolo di \textit{Programmatore} nell'ultimo \glo{sprint} di periodo ha richiesto più ore del previsto a causa della mancata realizzazione di tutti gli obiettivi dello \glo{sprint} precedente ed anche a causa della correzione di errori di codice imprevisti. \newline{}
...
La tabella seguente riporta il totale delle ore di lavoro effettivamente svolte dai singoli membri del gruppo durante il progetto, incluse le fasi di \textit{Analisi} e di \textit{Consolidamento dei \ignore{requisiti}}. Tutte le azioni di ridistribuzione delle ore durante le varie fasi sono state fatte cercando di bilanciare gli impegni lavorativi e personali di ogni componente; i membri hanno quindi monte ore lavorativo finale differenti.
...
La seguente tabella riporta i costi derivati dalle ore impiegate per ogni ruolo durante il progetto, incluse le fasi di \textit{Analisi} e di \textit{Consolidamento dei \ignore{requisiti}}.
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c c c c c c c c }
				...
				\ignore{Sprint} 8  & 3103 \euro{} & 3058 \euro{} \\
				\ignore{Sprint} 9  & 3120 \euro{} & 3120 \euro{} \\
				\ignore{Sprint} 10 & 883 \euro{} & 883 \euro{} \\
				\ignore{Sprint} 11 & 824 \euro{} & 824 \euro{} \\
				\ignore{Sprint} 12 & 791 \euro{} & 821 \euro{} \\
...
La seguente tabella riporta i costi derivati dalle ore impiegate per ogni ruolo durante il progetto, a partire dalla fase di \textit{Progettazione architetturale} inclusa.
...
\setlength{\freewidth}{\dimexpr\textwidth-0\tabcolsep}
	...
	\begin{longtable}{L{.210\freewidth} L{.6\freewidth} }
		...
		\textbf{Responsabile di Progetto:} & L'incremento principale delle ore si è verificato per questo ruolo. Data la situazione lavorativa di molti membri è stato necessario un maggiore impegno nell'organizzazione delle ore. \\
				\textbf{Analista:} & Questo ruolo ha richiesto meno ore del previsto grazie ad una stretta interazione con l'azienda \glo{proponente} ed una minore complessità del problema in confronto a quanto preventivato. \\
		\textbf{Programmatore:} & Si è verificato un leggero incremento dell'impegno, in confronto a quanto preventivato, nel ruolo dovuto all'approccio \glo{test} driven development scelto dal gruppo. \\	
		\endhead		
		\hiderowcolors
		\caption{Ruoli nei quali si è verificata una differenza delle ore da quanto preventivato}
	\end{longtable}	
La scelta di utilizzare la metodologia \glo{agile} e di utilizzare il framework scrum ha portato ad una pianificazione più prona al cambiamento, riuscendo quindi a correggerla quanto possibile ad ogni \glo{sprint}. In conclusione, Dal momento che è stata la prima volta che si è affrontato un progetto di tale portata, il gruppo si ritiene soddisfatto dei risultati ottenuti e ritiene di aver effettuato un percorso formativo soddisfacente ed impegnativo.
