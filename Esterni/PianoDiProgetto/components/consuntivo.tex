...
La seguente tabella contiene i dati del consuntivo per il periodo di consolidamento dei requisiti:
\begin{table}[H]
		\begin{center}
			\setlength{\aboverulesep}{0pt}
			\setlength{\belowrulesep}{0pt}
...
\begin{itemize}
	...
	\item \textbf{Differenza economica:} +15 \euro{} (sono stati risparmiati x euro), per un investimento totale di 4342 \euro{}.
\end{itemize}
