...
La tabella seguente riporta il totale delle ore di lavoro effettivamente svolte dai singoli
membri del gruppo durante il progetto, incluse le fasi di Analisi e di Consolidamento dei
requisiti. Tutte le azioni di ridistribuzione delle ore durante le varie fasi sono state fatte cercando di bilanciare gli impegni lavorativi e la divisione equa dei compiti tra tutti i componenti del gruppo; i membri hanno quindi monte ore lavorativo finale differenti.
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c c c c c c c c }
				\rowcolor{AzzurroGruppo!30} 
				\textbf{Nome} & \textbf{RE} & \textbf{AM} & \textbf{AN} & \textbf{PR} & \textbf{VE} & \textbf{Totale ore}\\
				\toprule
				\Davide{}    & 9 & - & - & - & - & - \\
				\Giosue{}    & 7 & - & - & - & - & - \\
				\Francesco{} & 4 & - & - & - & - & - \\
				...
				\Matteo{}   & 18 & - & - & - & - & - \\
				\Tommaso{}   & 4 & - & - & - & - & - \\
				\textbf{Totale persona} & \textbf{-} & \textbf{-} & \textbf{-} & \textbf{-} & \textbf{-} & \textbf{-} \\
				\bottomrule
			\end{tabular}
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c c c c c c c c }
				...
				\textit{Programmatore}  & 191 (+1) & 2880,00 (+15,00) \\
				\textit{Verificatore}   & 288 (+5) & 4320,00 (+75,00)\\
				\textbf{Totale} & \textbf{963} & \textbf{18763} \\
				\bottomrule
			\end{tabular}
