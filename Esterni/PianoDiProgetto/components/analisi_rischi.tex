    ...
    \begin{table}[H]
        \begin{center}
            ...
            \begin{tabular}{ c p{10cm} }
                ...
                %\textbf{Prima colonna} & \textbf{Seconda colonna}  \\
                \toprule
                Descrizione & Precedentemente all'inizio del progetto didattico i membri del gruppo non si conoscevano. \\
    ...
    \begin{table}[H]
        \begin{center}
            ...
            \begin{tabular}{ c p{10cm} }
                ...
                Conseguenze & La consegna di documenti errati o di bassa qualità, oltre a dare un'impressione negativa a \proponente{}, causerebbe uno spreco di risorse per scovare e risolvere tali errori \\
                Occorrenza & Media \\
                Pericolosità & Alta \\
                ...
                Piano di contingenza & Il \RdP{} deve lavorare in maniera incrociata con i \vers{}, così da poter minimizzare l'occorrenza di sviste ed errori generici. \\
                \bottomrule
            \end{tabular}
