...
\setlength{\freewidth}{\dimexpr\textwidth-0\tabcolsep}
	...
	\begin{longtable}{L{.210\freewidth} L{.6\freewidth} L{.1\freewidth}}
		...
		\textbf{Rischio} & \textbf{Mitigazione} & \textbf{Efficacia}\\
		\hline
		Inesperienza gestionale & Si è riscontrato una differenza tra l'ammontare di ore stabilite per il lavoro e quelle effettivamente dovuto alle modifiche dei vari documenti e alla preparazione del \glo{\textit{Proof of Concept}}. Questo ha spinto il gruppo alla ridistribuzione del carico di lavoro in modo da non rischiare ritardi.  & Bassa\\
