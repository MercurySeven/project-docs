...
\subsection{Validazione e collaudo}
	...
	\begin{longtable}{L{.210\freewidth} L{.6\freewidth} L{.1\freewidth}}
		...
		\textbf{Rischio} & \textbf{Mitigazione} & \textbf{Efficacia}\\
		\hline
		Problematiche Hardware & Sono stati riscontrati dei problemi riguardanti i computer aventi il sistema operativo MacOS installato al momento della realizzazione dell'eseguibile. Ciò è stato risolto grazie a una continua collaborazione tra i membri del gruppo e all'aver speso tempo per comprendere a fondo la problematica.  & Alta\\
		Problematiche Software & FORSEEEEE & Alta\\
		\endhead		
		\hiderowcolors
