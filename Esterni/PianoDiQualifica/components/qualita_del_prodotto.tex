...
\item MCD6 Lunghezza della riga di codice;
\item MCD7 Brevità dei metodi.
\end{itemize}
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c C{6cm} C{3cm} C{3cm} }
				...
				\textbf{Metrica} & \textbf{Obiettivo} & \textbf{Valori accettati} & \textbf{Valori ottimali}  \\
				\toprule
				MPR3 & Soddisfazione requisiti obbligatori & $100 \%$ & $100 \%$ \\
				MPR4 & Soddisfazione requisiti opzionali & $ 0 \%$ & $ 100\%$ \\
				MVR1 & Percentuale di malfunzionamenti del programma in rapporto ai test eseguiti & $ 0\%$  & $0\%$ \\
				...
				MCD2 & Complessità ciclomatica & $0$ - $15$ & $0$ - $10$ \\
				MCD3 & Variabili non utilizzate & $0$ & $0$ \\
				MCD4 & Rapporto linee di codice e linee commentate & $5$ - $3$ & $3$ - $1$\\
				MCD5 & Code coverage & $80\%$-$100\%$ & $100\%$ \\
				MCD6 & Lunghezza della riga di codice & $0$-$140$ caratteri & $0$-$140$ caratteri \\
				MCD7 & Brevità dei metodi & $0$-$50$ istruzioni & $0$-$50$ istruzioni \\
				\bottomrule
			\end{tabular}
