...
I dati per le \glo{metriche} associate a questo particolare aspetto del \glo{software} verranno raccolti tramite sessioni di \glo{QA} svolte da di membri del gruppo \gruppo{}. \\
...
Per facilitare la creazione dei test viene utilizzato il framework di testing "unittest".
Viene inoltre utilizzato "wiremock" per la creazione di test di integrazione tra client e server.
Gli script di testing sono integrati con gli strumenti di sviluppo utilizzati dal team per garantire una continua verifica della qualità del codice prodotto. \\