...
L'obbiettivo del capitolato \textit{C7} proposto da \textit{Zextras} è la creazione di  un algoritmo e un'applicazione Desktop multipiattaforma per la sincronizzazione e il salvataggio su cloud di file,  appoggiandosi al servizio \glo{Zextras Drive}.  
