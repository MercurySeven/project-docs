...
Di seguito riportiamo i cruscotti dei valori riscontrati delle \glo{metriche} riguardanti il prodotto, descritte nel paragrafo \ref{QProcesso}. In particolare, le \glo{metriche} sono raggruppate in base al tipo, come normato nel documento \NdP{}.
...
\end{figure}
\subsubsection{Cruscotto qualità del software}
Di seguito riportiamo i cruscotti dei valori riscontrati delle \glo{metriche} riguardanti il codice, descritte nel paragrafo \ref{QualitàSW}. In particolare, le \glo{metriche} sono raggruppate in base al tipo, come normato nel documento \NdP{}.
...
\subsubsection*{MPR03 - soddisfazione \ignore{requisiti} obbligatori, MPR04 - soddisfazione \ignore{requisiti} opzionali }
...
\subsubsection*{MVR01 - percentuale malfunzionamenti \ignore{test}, MVR02 - comprensibilità delle funzionalità offerte, MVR04 -percentuale \ignore{test} passati, MVR05 -percentuale \ignore{test} falliti }
