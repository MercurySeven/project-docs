...
Dopo un'ora e mezza di prove per capire dove avessimo sbagliato nell'usare le API, abbiamo chiesto aiuto a Federico Rispo, il quale ci ha spiegato che le API hanno bisogno di specificare i cookie di autenticazione nell'header di richiesta.
