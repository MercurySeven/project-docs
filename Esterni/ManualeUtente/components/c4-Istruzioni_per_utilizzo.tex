...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \textbf{Manuale}: questa politica di sincronizzazione richiede l'interazione dell'utente in caso di \gloman{conflitto} tra file nel server e file nella cartella locale.
	\end{itemize}
