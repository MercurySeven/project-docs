...
\begin{enumerate}
	...
	\begin{itemize}
		\item \textbf{Client}: indica la politica nel quale i file presenti in locale hanno sempre la priorità sui file nel \glo{server}, vengono scaricati solamente file non presenti localmente;
		\item \textbf{Manuale}: indica la politica nella quale se è presente un conflitto tra la versione del file locale con quella del \glo{server} allora viene richiesta l'interazione dell'utente.
	\end{itemize}
