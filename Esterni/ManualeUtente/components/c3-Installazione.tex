...
Per installare ed avviare l'applicativo \gloman{SSD} bisogna i seguenti passaggi.
\subsection{Come scaricare il programma e le librerie}

\begin{itemize}
	\item \textbf{Scaricare}: tutto il programma è presente nella seguente \gloman{Repository}:\newline{}
