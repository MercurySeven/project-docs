...
\subsection{Codecov}
Per svolgere l'attività di \gloman{code coverage} è stato scelto di utilizzare Codecov. Per far eseguire le revisioni automatiche del codice bisogna attivare il \gloman{repository} di GitHub dal sito di Codecov.
