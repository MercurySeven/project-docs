...
Lo scopo di questo documento è illustrare tutte le funzionalità del \gloman{sync engine} richiesto dal \textit{capitolato C7}. L'utente finale in questo modo avrà dunque a disposizione tutte le indicazioni per il corretto uso del software.
