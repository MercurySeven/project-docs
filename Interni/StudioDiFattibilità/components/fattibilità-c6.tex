...
Il focus del progetto è però centrato nell'apprendere le tecnologie offerte da \glo{Amazon} attraverso la loro piattaforma \glo{AWS}.
...
\begin{itemize}
\item l'utilizzo dei servizi \glo{Amazon} \glo{AWS}, che al giorno d'oggi sono sempre più diffusi;
