...
\begin{itemize}
\item utilizzo di \glo{Java} e \glo{Angular} per lo sviluppo delle parti di back-end e di front-end della componente Web
Application del sistema;
\item per la gestione delle mappe (heatmap ecc.) il framework \glo{Leaflet};
