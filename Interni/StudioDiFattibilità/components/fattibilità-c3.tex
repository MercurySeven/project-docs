...
\item utilizzo del pattern \glo{Publisher/Subscriber}, e adozione del protocollo \glo{MQTT}.
\end{itemize}
...
\item la fase di \glo{test} potrebbe essere complessa;
