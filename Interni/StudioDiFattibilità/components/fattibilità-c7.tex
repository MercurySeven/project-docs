...
L'interfaccia deve essere multipiattaforma e il prodotto deve essere sviluppato aderendo al pattern \glo{MVC}.
...
\item funzionalità presenti in altre soluzioni attualmente disponibili:
    ...
    \item integrazione con il protocollo \glo{MAPI} per permettere l'integrazione con applicazioni di \glo{IM}.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textbf{\glo{Framework Qt}}: framework consigliato per lo sviluppo di interfacce grafiche basato su \glo{C++};
    \item \textbf{\glo{Python}}: linguaggio consigliato per lo sviluppo del modello. Molto flessibile. Supportato dalla maggior parte dei framework per lo sviluppo di interfacce grafiche. 
...
\item il team ha già familiarità con il \glo{framework Qt} e \glo{Python}.
\end{itemize}
