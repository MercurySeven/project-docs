...
\item la libreria \glo{JavaScript} D3.js per la creazione dei grafici da visualizzare all'utente;
...
\item la libreria \glo{JavaScript} D3.js è molto ben documentata, su internet ci sono molte risorse utili per l'implementazione dei grafici richiesti.
\end{itemize}
