...
\end{itemize}
\paragraph{Indici}     
In ogni documento è presente un indice che fornisce una visione sintetica della struttura del documento. L'indice è strutturato in sezioni, sottosezioni e paragrafi aventi numeri progressivi separati tra loro da un punto.\newline
