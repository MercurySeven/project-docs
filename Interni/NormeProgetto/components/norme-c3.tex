...
retrocompatibile; la numerazione parte da 0 e non viene annullata; \textbf{B} la numerazione incrementa ad ogni \textit{scrum}, partendo da 0 e non venendo mai annullata; la crescita di questo indice rappresenta un incremento nello sviluppo totale del prodotto.
	\end{itemize}
