...
Tutti i documenti prodotti verranno spartiti tra due categorie:
\begin{itemize}
	\item \textbf{Interni}: legati all'organizzazione interna,  vengono visualizzati principalmente dai membri del gruppo;
	\item \textbf{Esterni}: interessano i committenti e il proponente,  avranno una versione e verranno consegnati previa approvazione del \textit{Responsabile di Progetto}.
\end{itemize}
Entrambe le categorie saranno provviste di storico delle versioni e di approvazione della versione più recente.
In particolare,  verranno prodotti i seguenti tipi di documenti:
\begin{itemize}
