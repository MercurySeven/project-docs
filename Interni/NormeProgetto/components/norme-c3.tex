...
\begin{itemize}
	...
	\item \textbf{Corsivo:} viene applicato per i nomi propri (per la precisione i membri del gruppo, il proponente, i committenti), per citare il nome di un documento, privo della sua versione, e dei termini che fanno parte del glossario;
