...
\subsubsection{Descrizione}
Il processi di Verifica si compone di due attività che permettono di verificare che il prodotto sia conforme alle aspettative di analisi (\S{}\ref{Analisi}) e di test (\S{}\ref{Test}). Esso viene applicato su ogni processo in esecuzione:
\begin{itemize}
