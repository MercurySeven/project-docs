...
L'attività di progettazione definisce, in funzione dei requisiti specificati nel documento \AdR{}, le caratteristiche che il prodotto richiesto deve avere in modo di fornire la soluzione migliore che soddisfi i requisiti degli \glo{stakeholders}.  Questa fase provvede a:
\begin{itemize}
...
\paragraph{Test}
Ogni \prog{} avrà inoltre il compito di definire test opportuni, che dovranno essere accompagnati da eventuali classi utili ad individuare errori ed anomalie.
