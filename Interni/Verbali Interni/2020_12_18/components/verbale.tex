...
Lo script, nella prima fase, utilizza delle regex per censire in un database tuttle le parole comprese nel comando "glo" ovvero quelle parole che necessitano di una definizione nel \G{}.\\
