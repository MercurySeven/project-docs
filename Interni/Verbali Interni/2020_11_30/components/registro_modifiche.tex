\section*{\centerline{Registro delle modifiche}}
{
	...
	\begin{longtable}{C{.131777\freewidth} C{.134036\freewidth} C{.263554\freewidth} C{.188254\freewidth} C{.282379\freewidth}}
		...
		v0.1.0 & \DataDoc{} & Lucrezia Gradi &  \textit{Progettista} & Revisione complessiva del documento (\textit{Verificatore}: Daniele Giachetto) \\ 
		v0.0.1 & \DataDoc{} & Lucrezia Gradi &  \textit{Progettista} & Stesura del documento (\textit{Verificatore} : Daniele Giachetto) \\
