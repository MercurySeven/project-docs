...
\setlength{\freewidth}{\dimexpr\textwidth-0\tabcolsep}
	...
	\begin{longtable}{L{.210\freewidth} L{.6\freewidth} L{.080\freewidth}}
		...
		\textbf{\ignore{Gmail}} & Account che rappresenta l’intero gruppo \Mail{}); utilizzato per interagire con gli \glo{stakeholder} e i committenti, per creare l’account su \glo{GitHub} ed il corrispondente \glo{repository} \\
		\textbf{\ignore{Slack}} & Utilizzato per le comunicazioni interne ed esterne \\
		\textbf{\ignore{Telegram}} & Utilizzato per le comunicazioni più rapide e informali tra i membri del
gruppo \\
