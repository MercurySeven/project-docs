...
\begin{itemize}
	\item \textbf{GitHub}: per gestire la pubblicazione di questo progetto è stata creata un repository su GitHub dove risiederanno tutti i documenti e il codice approvati;
