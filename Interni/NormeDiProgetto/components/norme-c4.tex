...
\begin{itemize}
	\item \textbf{\glo{GitHub}}: per gestire la pubblicazione di questo progetto è stata creata un \glo{repository} su GitHubG dove risiederanno tutti i documenti e il codice approvati;
