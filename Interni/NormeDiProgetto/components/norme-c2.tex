...
\subsubsection{Metriche}
{
	...
	\begin{longtable}{L{.1\freewidth} L{.15\freewidth} L{.4\freewidth} L{.2\freewidth}}
		...
		\textbf{MCD08} & Fan-in & Indica quante componenti utilizzano un modulo. & Fan-in $\leq 5$ \\
		\textbf{MCD09} & Fan-out & Indica quante componenti vengono utilizzate dalla componente in esame. & Fan-out $\geq 1$ \\
