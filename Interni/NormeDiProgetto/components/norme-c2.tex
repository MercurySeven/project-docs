...
\setlength{\freewidth}{\dimexpr\textwidth-0\tabcolsep}
	...
	\begin{longtable}{L{.365\freewidth} L{.6 \freewidth}}
		...
		\textbf{\glo{Proof of Concept} e Technology Baseline} & Definiscono una panoramica ad alto livello dell'applicazione che il gruppo realizzerà e delle tecnologie impiegate. \\
...
\subsubsection{Scopo e aspettative}
Lo scopo del processo di Sviluppo è descrivere i compiti e le attività da svolgere relative al prodotto \glo{software} da sviluppare.
...
\begin{itemize}
	...
	\item realizzare un prodotto finale che superi i \glo{test}, che soddisfi i \glo{requisiti} e le richieste del \glo{proponente}. 
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
 		\item \glo{tracciamento} dei \glo{requisiti}, suddivisi in obbligatori, desiderabili e opzionali, individuati nel \glo{sistema} durante l'analisi; 
		\item \glo{tracciamento} fonte-\ignore{requisiti} e \ignore{requisiti}-fonte. 
	\end{itemize}
\end{itemize} 
...
\subsubsection*{\ignore{Metriche} Codifica}
	...
	\begin{longtable}{L{.10\freewidth} L{.5\freewidth} L{.250\freewidth}}
		...
		\textbf{MCD08}& Misura il numero di classi che sono accoppiate a una particolare classe. Un accoppiamento eccessivo rende il \glo{sistema} più difficile da gestire e riutilizzare. & - \\
...
\newpage{}
\subsubsection*{\ignore{Metriche} Progettazione}
