...
\setlength{\freewidth}{\dimexpr\textwidth-0\tabcolsep}
	...
	\begin{longtable}{L{.210\freewidth} L{.6\freewidth} L{.080\freewidth}}
		...
		\toprule
		\endhead		
		Diagrammi delle attività & mostrano tutte le operazioni di una certa attività, anche fuori dal contesto. \\
		Diagrammi delle classi & mostrano gli attributi e i metodi di classi e tipi.\\
		DIagrammi dei package & mostrano i raggruppamenti tra le classi. \\
		Diagrammi di sequenza & mostrano sequenze di azioni usando scelte definite.. \\
		\bottomrule
		\hiderowcolors
...
\textit{Il gruppo si riserva la possibilità di ampliare opportunamente la sezione in futuro.}
{
	...
	\begin{longtable}{L{.1\freewidth} L{.15\freewidth} L{.4\freewidth} L{.2\freewidth}}
		...
		\toprule
		\endhead		
		MCD03 & Variabili non utilizzate & Il codice non deve avere variabili inutilizzate, esse andrebbero ad intaccare le performance e la facilità di manutenzione del codice & - \\
		MCD04 & Facilità di comprensione & Indice che riporta la facilità con cui l'utente riesce a comprendere cosa fa il codice, rappresentata mediante il numero di linee di commento nel codice & \small{R=$\frac{n^\circ\ linee\ commento}{n^\circ\ linee\ codice}$}  \\
		MCD05 & Code coverage & Metrica che riporta la quantità di codice coperta da \glo{test}. Più questo valore aumenta e più il codice può ricevere implementazioni ed il cliente utilizzarlo senza incorrere in problemi & - \\
		MCD06 & Lunghezza della riga di codice & Per facilitare la lettura e la riduzione della complessità di una singola riga di codice non sarà possibile avere righe di codice più lunghe di quanto stabilito dalla metrica & - \\
		MCD07 & Brevità dei metodi & I metodi devono generalmente essere brevi per poter assicurare che la loro complessità non risulti eccessiva & - \\
		\bottomrule
		\hiderowcolors
