...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.14]{components/immagini/casouso.jpg}
...
\textit{Il gruppo si riserva la possibilità di ampliare opportunamente la sezione in futuro.}
{
	...
	\begin{longtable}{L{.1\freewidth} L{.15\freewidth} L{.4\freewidth} L{.2\freewidth}}
		...
		\toprule
		\endhead		
		\textbf{MCD03 }& Variabili non utilizzate & Il codice non deve avere variabili inutilizzate, esse andrebbero ad intaccare le performance e la facilità di manutenzione del codice & n° variabili inutilizzate == 0\\
