...
\subsubsection*{Metriche}
	...
	\begin{longtable}{L{.10\freewidth} L{.5\freewidth} L{.250\freewidth}}
		...
		\textbf{MPR06} & Indica la percentuale dei \glo{requisiti} obbligatori soddisfatti & percentuale dei requisiti obbligatori implementati\\
		\textbf{MPR07} & Indica la percentuale dei \glo{requisiti} opzionali soddisfatti & percentuale dei requisiti opzionali implementati\\
		\bottomrule
		\hiderowcolors
