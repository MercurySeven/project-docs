...
\begin{itemize}
	...
	\item \textbf{collaudo}: attività di controllo che si svolge con la presenza del committente durante la \emph{Revisione di Accettazione}. Il gruppo deve quindi dimostrare di aver implementato tutti i requisiti, in questo senso, per una corretta e facile verifica, è fondamentale il \glo{tracciamento} dei test e dei requisiti che validano.
\end{itemize}
