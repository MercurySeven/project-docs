...
\begin{itemize}
	...
	\item controllare che il sistema soddisfi i requisiti.
\end{itemize}
...
\setlength{\freewidth}{\dimexpr\textwidth-0\tabcolsep}
	...
	\begin{longtable}{L{.20\freewidth} L{.70\freewidth}}
		...
		\toprule
		\endhead
		\textbf{\progs{}} & Si occupano della pianificazione e implementazione dei test.\\
		\textbf{\vers{}} & Eseguono i test sul software e aggiornano il \PdQ{} con i risultati ottenuti.\\
		\textbf{\RdP{}} & Osserva i risultati ottenuti per mezzo del \PdQ e decide se accettare il risultato ottenuto, nel caso in cui i risultati dei test risultano sufficienti, oppure ripetere. \\
		\bottomrule
		\hiderowcolors
		\caption{Attività del processo di validazione del codice}
	\end{longtable}
