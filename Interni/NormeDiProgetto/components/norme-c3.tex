...
\subsubsection{Descrizione}
Il processo di \glo{verifica} si compone di due attività che permettono di verificare che il prodotto sia conforme alle aspettative di analisi (\S{}\ref{Analisi}) e di \glo{test} (\S{}\ref{\glo{Test}}). Esso viene applicato al \glo{software} ed ai documenti.
\subsubsection{Aspettative}
...
\begin{itemize}
	\item \glo{Test di \glo{unità}};
	\item \glo{Test di integrazione};
	\item \glo{Test di \glo{sistema}};
