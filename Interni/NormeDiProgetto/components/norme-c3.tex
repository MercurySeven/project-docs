...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c C{6cm} C{3cm} C{3cm} }
				...
				MVR04 & Passed Test Cases Percentage, rappresenta la percentuale dei test superati sul totale dei test eseguiti. &  \\
				MVR05 & Failed Test Cases Percentage, rappresenta la percentuale dei test falliti sul totale dei test eseguiti. &\\
				\bottomrule
			\end{tabular}
