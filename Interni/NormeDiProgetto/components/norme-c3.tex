...

{
	...
	\begin{longtable}{L{.1\freewidth} L{.15\freewidth} L{.3\freewidth} L{.35\freewidth}}
		...
		\textbf{MDC03} & Correttezza Ortografica & Indice che riporta la correttezza ortografica del testo.  & - \\
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c C{6cm} C{3cm} C{3cm} }
				...
				MVR04 & Passed Test Cases Percentage, rappresenta la percentuale dei test superati sul totale dei test eseguiti. &  $\frac{numero test superati}{numero test eseguiti}*100$ \\
				MVR05 & Failed Test Cases Percentage, rappresenta la percentuale dei test falliti sul totale dei test eseguiti. & $\frac{numero test non superati}{numero test eseguiti}*100$\\
				\bottomrule
			\end{tabular}
