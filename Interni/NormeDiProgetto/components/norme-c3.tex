...

{
	...
	\begin{longtable}{L{.1\freewidth} L{.15\freewidth} L{.3\freewidth} L{.35\freewidth}}
		...
		\textbf{MDC02} & Indice di Flesch-Vacca & Indice che riporta il grado di leggibilità di un testo & \small{$Ifv = 206-0.65 * (sillabe di 100 parole) - (media di parole per frase)$}\\
		\textbf{MDC03} & Correttezza Ortografica & Indice che riporta la correttezza ortografica del testo. Questo valore deve essere il più elevato possibile come indicato nel \PdQ{} & Correttezza >= 95\% \\
...
\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{ c C{6cm} C{3cm} C{3cm} }
				...
				\toprule
				MPR01 & Actual cost of work performed, denaro speso fino al momento del calcolo. & ACWP $\leq BCWS$ & ACWP $\leq budget totale$\\
				MPR02 & Budgeted Cost of Work Scheduled, costo pianificato per realizzare le attività di progetto fino al momento del calcolo. & BCWS $\geq 0 $& BCWS $\geq 0$ \\
				MPR03 & Budgeted Cost of Work Performed, costo del lavoro fatto fino al momento del calcolo. & BCWP $\geq 0$ & BCWP $\geq 0$ \\
				MPR04 & Schedule variance, indica se si è in linea, in anticipo oppure in ritardo rispetto alla pianificazione delle attività di progetto. & SV = 0 & SV $\geq 0$ \\
				MPR05 & Budget variance, indica se alla data corrente si è speso di più o di meno rispetto al budget totale pianificato. & BV $\leq ACWP$ & BV$ \leq Budget totale$ \\
				MPR06 & Soddisfazione \glo{requisiti} obbligatori & $100 \%$ & $100 \%$ \\
				MPR07 & Soddisfazione \glo{requisiti} opzionali & $ 0 \%$ & $ 100\%$ \\
				...
				MVR04 & Passed Test Cases Percentage, rappresenta la percentuale dei test superati sul totale dei test eseguiti. & $90\%$ - $100\% $& $100\%$ \\
				MVR05 & Failed Test Cases Percentage, rappresenta la percentuale dei test falliti sul totale dei test eseguiti. &$ 0\%$ - $10\%$ & $0\%$\\
